...
def run():
    ...
    link = '[©Developed by kamal](https://www.linkedin.com/in/kamal-k-952603203/)'
...
st.write('''
    Dashboard created by [kamal](https://www.linkedin.com/in/kamal-k-952603203/), with [Streamlit](https://www.streamlit.io).
    See the code on [GitHub](https://github.com/kkamalk).
